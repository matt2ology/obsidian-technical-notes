...
>
> > $\begin{align*} y=2 \quad \checkmark \\ \\ x+2\left(2\right)&=1 \\ x&=-3 \end{align*}$
...
$3x+4y=1\:\Rightarrow \:y=-\frac{1}{2}x+\frac{1}{2}$
...
>
> $\Large x_1-3x_2=5$ >$\Large -x_1+x_2+5x_3=2$ >$\Large x_2+x_3=0$
>
